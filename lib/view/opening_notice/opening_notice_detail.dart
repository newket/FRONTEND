                                            ...
                                            Row(
                                              ...
                                              children: [
                                                ...
                                                Column(
                                                  ...
                                                  children: [
                                                    Text(
                                                      "${ticketResponse.ticketingSchedule[0].type} 오픈일",
                                                      textAlign: TextAlign.center,
                                                      style: const TextStyle(
                                                        fontFamily: 'Pretendard',
                                                        fontSize: 11,
                                                    ...
                                                    Text(
                                                      "${ticketResponse.ticketingSchedule[0].date} ${ticketResponse.ticketingSchedule[0].time}",
                                                      textAlign: TextAlign.center,
                                                      style: const TextStyle(
                                                        fontFamily: 'Pretendard',
                                                        fontSize: 12,
                                                ...
                                                if (ticketResponse.ticketingSchedule.length == 2) ...[
                                                  Container(
                                                    color: b_800,
                                                    // 세로 실선 색상
                                                    width: 1,
                                                  ...
                                                  Column(
                                                    ...
                                                    children: [
                                                      Text(
                                                        "${ticketResponse.ticketingSchedule[1].type} 오픈일",
                                                        textAlign: TextAlign.center,
                                                        style: const TextStyle(
                                                          fontFamily: 'Pretendard',
                                                          fontSize: 11,
                                                      ...
                                                      Text(
                                                        "${ticketResponse.ticketingSchedule[1].date} ${ticketResponse.ticketingSchedule[1].time}",
                                                        textAlign: TextAlign.center,
                                                        style: const TextStyle(
                                                          fontFamily: 'Pretendard',
                                                          fontSize: 12,
