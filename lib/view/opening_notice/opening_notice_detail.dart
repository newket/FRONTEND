                                ...
                                Padding(
                                    ...
                                    child: Column(
                                      ...
                                      children: [
                                        ...
                                        const SizedBox(height: 12),
                                        //선예매 오픈 일반예매 오픈
                                        if (ticketResponse.ticketProvider[0]
                                                .ticketingSchedule.length ==
                                            2)
                                          Row(
                                            children: [
                                              Container(width: 56),
                                          ...
                                          children: List.generate(
                                            ...
                                            (index) {
                                              ...
                                              switch (ticketProvider) {
                                                case 'INTERPARK':
                                                  imageUrl =
                                                      "images/ticket_detail/interpark.png";
                                                  break;
                                                case 'MELON':
                                                  imageUrl =
                                                      "images/ticket_detail/melon.png";
                                                  break;
                                                case 'YES24':
                                                  imageUrl =
                                                      "images/ticket_detail/yes24.png";
                                                  break;
                                                case 'TICKETLINK':
                                                  imageUrl =
                                                      "images/ticket_detail/ticketlink.png";
                                                  break;
                                                default:
                                                  imageUrl = null;
                                              }
