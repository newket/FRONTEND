...
class OnSaleDetailV2 extends StatefulWidget {
  const OnSaleDetailV2({super.key, required this.concertId});

  final int concertId;

  @override
  State<StatefulWidget> createState() => _OnSaleDetailV2();
}

class _OnSaleDetailV2 extends State<OnSaleDetailV2> {
