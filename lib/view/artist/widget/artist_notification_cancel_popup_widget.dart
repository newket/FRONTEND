...
class ArtistNotificationCancelPopupWidget extends StatelessWidget {
  final ArtistDto artist;
  final VoidCallback onConfirm;

  const ArtistNotificationCancelPopupWidget({super.key, required this.artist, required this.onConfirm});
