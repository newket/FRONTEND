  ...
  Widget build(BuildContext context) {
    ...
    return AnnotatedRegion<SystemUiOverlayStyle>(
        value: SystemUiOverlayStyle(
          // 상태바 (Android)
          statusBarColor: (_scrollPosition == 0) ? Colors.white : Colors.black,
          // 상태바 배경 (iOS)
          statusBarBrightness: (_scrollPosition == 0) ? Brightness.light : Brightness.dark,
          // 상태바 아이콘 (ios)
          statusBarIconBrightness: (_scrollPosition == 0) ? Brightness.light : Brightness.dark,
          //하단바 색상 (Android)
                                                ...
                                                itemBuilder: (context, index) {
                                                  return Padding(
                                                      ...
                                                      child: GestureDetector(
                                                          ...
                                                          child: ArtistHorizontalListWidget(
                                                              artist: response.members[index])));
                                                })),
                                      ],
                                    )
                                  : const SizedBox(),
                                                      ...
                                                      Navigator.push(
                                                        ...
                                                        MaterialPageRoute(
                                                          builder: (context) => TicketDetailScreen(
                                                            ticketId:
                                                                response.beforeSaleTickets.tickets[index].ticketId,
                                                          ),
                                                        ),
                                                      );
                                                      AmplitudeConfig.amplitude.logEvent(
                                            ...
                                            (index) {
                                              return Column(children: [
                                                GestureDetector(
                                                  ...
                                                  child: OnSaleWidget(
                                                      onSaleResponse: response.onSaleTickets, index: index),
                                                ),
                                                const SizedBox(height: 12)
                                              ]);
                                            },
                                                      ...
                                                      onTap: () {
                                                        Navigator.push(
                                                          ...
                                                          MaterialPageRoute(
                                                            builder: (context) => TicketDetailScreen(
                                                              ticketId:
                                                                  response.afterSaleTickets.tickets[index].ticketId,
                                                            ),
                                                          ),
                                                        );
                                                        AmplitudeConfig.amplitude.logEvent(
