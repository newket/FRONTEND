...
class PrivacyPolicyV2 extends StatefulWidget {
  const PrivacyPolicyV2({super.key});

  @override
  State<StatefulWidget> createState() => _PrivacyPolicyV2();
}

class _PrivacyPolicyV2 extends State<PrivacyPolicyV2> {
  @override
  void initState() {
    super.initState();
  }
